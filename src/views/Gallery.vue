<template>
  ...
  >
    <p v-scroll-to="'#rooms'">Rooms</p>
    <p v-scroll-to="'#terrace'">Terrace</p>
    <p v-scroll-to="'#bathroom'">Bathroom</p>
    <p v-scroll-to="'#kitchen'">Kitchen</p>
    <p v-scroll-to="'#parkingarea'">Parking Area</p>
    <p v-scroll-to="'#outdoor'">Outdoor</p>
  </div>
